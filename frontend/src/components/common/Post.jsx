        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex justify-between mt-3">
            <div className="flex gap-4 items-center w-2/3 justify-between">
              ...
              >
                <div className="modal-box rounded border border-gray-600 bg-black">
                  ...
                  >
                    <textarea
                      className="textarea w-full p-1 rounded text-md resize-none border focus:outline-none border-gray-800 bg-transparent text-white placeholder:text-slate-400"
